...
Canonical repo: **https://github.com/AiLang-Author/AIMacro-Language** (`main`).
Syntax is **`{ }` blocks**, not `end`. The 2025 `end` tree is `archive/end-syntax-2025`.
Active grind branch (when used): **`aimacro/class-body-parse-fixes`**.
