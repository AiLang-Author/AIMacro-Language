...
**Last updated:** 2026-09-24 (bar: all 585 must transpile **and** compile. 3.11 transpile **537/585**, in-scope **380/395**. Compile probe **0/26**. Overnight codegen: [GROKBOT_CODEGEN.md](GROKBOT_CODEGEN.md) on `grokasaurus2`. Parse grind: [GROKBOT_PARSE.md](GROKBOT_PARSE.md) on `aimacro/class-body-parse-fixes`. curated 25/25; matrix 62/62/62; SIGSEGV 0; fizzbuzz 211054)
